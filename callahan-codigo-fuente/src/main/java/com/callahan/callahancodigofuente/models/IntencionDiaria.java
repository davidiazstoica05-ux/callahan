...
public enum IntencionDiaria {
    ...
    DESCONECTAR_Y_REIR(List.of(35)),      // Comedia, Película de TV (ligeras)
    ADRENALINA_PURA(List.of(28)),            // Acción, Aventura
    ...
    ESTIMULAR_LA_MENTE(List.of(878)),        // Ciencia Ficción, Fantasía
    CULTURIZARME(List.of(99)),               // Documental, Historia

    // 3. Estados emocionales y tranquilos
    LLORAR_A_MARES(List.of(18)),                 // Drama
    CREER_EN_EL_AMOR(List.of(10749)),            // Romance
    TARDE_CONFORTABLE(List.of(10751)),       // Familia, Animación
    DISFRUTAR_MUSICA(List.of(10402)),            // Música

    // 4. Estados de nicho / Intensos
    EPICA_CLASICA(List.of(10752));           // Guerra, Western
